...
var Socket = function () {
  ...
  _createClass(Socket, [{
    ...
    key: "debug",
    value: function debug(label, message) {
...
var _serializers = __webpack_require__(84);
...
var SocketWorker = function () {
  function SocketWorker(options) {
    ...
    var mode = options.serializationMode || undefined;
    this.Serializer = new _serializers2.default(mode);
  ...
  _createClass(SocketWorker, [{
    ...
    value: function messageHandler($e) {
      ...
      var messageObj = Object.assign({}, $e.data);
    ...
    key: '_executeMessage',
    value: function _executeMessage(messageObj) {
      var message = Object.assign({}, messageObj); // clone so we don't mutate
...
var _json = __webpack_require__(85);
