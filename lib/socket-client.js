...
var emitter = {};
_ampersandEvents2.default.createEmitter(emitter);
...
function SocketWorker(socketOptions) {
  ...
  var socketWorker = new _socketWorker2.default();
